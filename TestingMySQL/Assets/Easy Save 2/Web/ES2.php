...
$db_host 		= 	"mysql12.mydevil.net"; 	// MySQL Host Name.
$db_user 		= 	"m1147_test"; 	// MySQL User Name.
$db_password 	= 	"Loll123"; 	// MySQL Password.
$db_name 		= 	"m1147_100pushupsgo"; 	// MySQL Database Name.

// *** GENERAL DETAILS ***
// If you are not using your own login system, replace these with your Unity username and password.

$unityUsername = "test"; //This should match the webUsername set in Unity.
$unityPassword = "tset321"; //This should match the webPassword set in Unity.
